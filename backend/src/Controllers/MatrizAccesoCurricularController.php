...
use App\Services\MatrizAccesoCurricularService;
use App\Middleware\AuthMiddleware;
use App\Helpers\Response;

class MatrizAccesoCurricularController
{
    private MatrizAccesoCurricularService $service;

    public function __construct()
    {
        $this->service = new MatrizAccesoCurricularService();
    }
    ...
    public function show(array $params): void
    {
        ...
        if (!$result) Response::notFound('Acceso curricular no encontrado');
    ...
    public function toggleVigencia(array $params): void
    {
        ...
        if (!$deleted) Response::notFound('Acceso curricular no encontrado');
