...
use App\Services\MatrizProgresionService;
use App\Middleware\AuthMiddleware;
use App\Helpers\Response;

class MatrizProgresionController
{
    private MatrizProgresionService $service;

    public function __construct()
    {
        $this->service = new MatrizProgresionService();
    }
