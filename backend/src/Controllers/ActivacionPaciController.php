...
use App\Services\ActivacionPaciService;
use App\Middleware\AuthMiddleware;
use App\Helpers\Response;

class ActivacionPaciController
{
    private ActivacionPaciService $service;

    public function __construct()
    {
        $this->service = new ActivacionPaciService();
    }
    ...
    public function index(array $params): void
    {
        ...
        $filters = array_intersect_key($_GET, array_flip(['eje', 'core_nivel', 'id_oa', 'habilidad_detectada']));
