...
use App\Services\MatrizHabilidadBaseService;
use App\Middleware\AuthMiddleware;
use App\Helpers\Response;

class MatrizHabilidadBaseController
{
    private MatrizHabilidadBaseService $service;

    public function __construct()
    {
        $this->service = new MatrizHabilidadBaseService();
    }
    ...
    public function show(array $params): void
    {
        ...
        if (!$result) Response::notFound('Habilidad base no encontrada');
    ...
    public function toggleVigencia(array $params): void
    {
        ...
        if (!$deleted) Response::notFound('Habilidad base no encontrada');
