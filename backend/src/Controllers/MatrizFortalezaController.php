...
use App\Services\MatrizFortalezaService;
use App\Middleware\AuthMiddleware;
use App\Helpers\Response;

class MatrizFortalezaController
{
    private MatrizFortalezaService $service;

    public function __construct()
    {
        $this->service = new MatrizFortalezaService();
    }
    ...
    public function show(array $params): void
    {
        ...
        if (!$result) Response::notFound('Fortaleza no encontrada');
    ...
    public function toggleVigencia(array $params): void
    {
        ...
        if (!$deleted) Response::notFound('Fortaleza no encontrada');
