...
use App\Services\MatrizEstrategiaEscrituraService;
use App\Middleware\AuthMiddleware;
use App\Helpers\Response;

class MatrizEstrategiaEscrituraController
{
    private MatrizEstrategiaEscrituraService $service;

    public function __construct()
    {
        $this->service = new MatrizEstrategiaEscrituraService();
    }
    ...
    public function show(array $params): void
    {
        ...
        if (!$result) Response::notFound('Estrategia de escritura no encontrada');
    ...
    public function toggleVigencia(array $params): void
    {
        ...
        if (!$deleted) Response::notFound('Estrategia de escritura no encontrada');
