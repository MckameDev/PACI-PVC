...
use App\Services\ProgresionCurricularService;
use App\Middleware\AuthMiddleware;
use App\Helpers\Response;

class ProgresionCurricularController
{
    private ProgresionCurricularService $service;

    public function __construct()
    {
        $this->service = new ProgresionCurricularService();
    }
    ...
    public function index(array $params): void
    {
        ...
        $filters = array_intersect_key($_GET, array_flip(['habilidad', 'nivel_core', 'eje']));
