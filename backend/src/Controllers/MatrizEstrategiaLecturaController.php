...
use App\Services\MatrizEstrategiaLecturaService;
use App\Middleware\AuthMiddleware;
use App\Helpers\Response;

class MatrizEstrategiaLecturaController
{
    private MatrizEstrategiaLecturaService $service;

    public function __construct()
    {
        $this->service = new MatrizEstrategiaLecturaService();
    }
    ...
    public function show(array $params): void
    {
        ...
        if (!$result) Response::notFound('Estrategia de lectura no encontrada');
    ...
    public function toggleVigencia(array $params): void
    {
        ...
        if (!$deleted) Response::notFound('Estrategia de lectura no encontrada');
