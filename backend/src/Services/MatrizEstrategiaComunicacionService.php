...
use App\Models\MatrizEstrategiaComunicacion;
use App\Helpers\Validator;
use App\Helpers\Response;

class MatrizEstrategiaComunicacionService
{
    private MatrizEstrategiaComunicacion $model;

    public function __construct()
    {
        $this->model = new MatrizEstrategiaComunicacion();
    }
    ...
    public function create(array $data, ?string $userId): array
    {
        $validator = Validator::make($data, [
            ...
            'nivel_sugerido'         => 'nullable|string|max:100',
            'descripcion_pedagogica' => 'nullable|string',
            'foco_intervencion'      => 'nullable|string|max:255',
        ...
        if (!$this->model->isUnique('nombre', $data['nombre'])) {
            Response::error('La estrategia de comunicación ya existe', 409);
        }
