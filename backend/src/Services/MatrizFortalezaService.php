...
use App\Models\MatrizFortaleza;
use App\Helpers\Validator;
use App\Helpers\Response;

class MatrizFortalezaService
{
    private MatrizFortaleza $model;

    public function __construct()
    {
        $this->model = new MatrizFortaleza();
    }
    ...
    public function create(array $data, ?string $userId): array
    {
        $validator = Validator::make($data, [
            ...
            'descripcion_ia' => 'nullable|string',
            'valor_dua'     => 'nullable|string|max:100',
        ...
        if (!$this->model->isUnique('nombre', $data['nombre'])) {
            Response::error('La fortaleza ya existe', 409);
        }
