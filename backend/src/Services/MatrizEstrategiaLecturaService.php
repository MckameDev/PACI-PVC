...
use App\Models\MatrizEstrategiaLectura;
use App\Helpers\Validator;
use App\Helpers\Response;

class MatrizEstrategiaLecturaService
{
    private MatrizEstrategiaLectura $model;

    public function __construct()
    {
        $this->model = new MatrizEstrategiaLectura();
    }
    ...
    public function create(array $data, ?string $userId): array
    {
        $validator = Validator::make($data, [
            ...
            'momento_lectura'        => 'nullable|string|max:100',
            'descripcion_pedagogica' => 'nullable|string',
            'objetivo_metacognitivo' => 'nullable|string',
        ...
        if (!$this->model->isUnique('nombre', $data['nombre'])) {
            Response::error('La estrategia de lectura ya existe', 409);
        }
