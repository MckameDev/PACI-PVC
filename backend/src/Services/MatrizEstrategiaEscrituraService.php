...
use App\Models\MatrizEstrategiaEscritura;
use App\Helpers\Validator;
use App\Helpers\Response;

class MatrizEstrategiaEscrituraService
{
    private MatrizEstrategiaEscritura $model;

    public function __construct()
    {
        $this->model = new MatrizEstrategiaEscritura();
    }
    ...
    public function create(array $data, ?string $userId): array
    {
        $validator = Validator::make($data, [
            ...
            'problema_ataca' => 'nullable|string|max:255',
            'descripcion'   => 'nullable|string',
            'tipo_apoyo'    => 'nullable|string|max:100',
        ...
        if (!$this->model->isUnique('nombre', $data['nombre'])) {
            Response::error('La estrategia de escritura ya existe', 409);
        }
